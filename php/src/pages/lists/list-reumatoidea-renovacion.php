  ...
  <body class="bg-light">
    ...
    <nav class="mt-2 mx-2" style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item badge bg-light active" aria-current="page">Lista de PAMI: Reumatoidea Renovación</li>
      </ol>
    </nav>
    <div class="container-fluid">
      <h1 class="display-6 text-uppercase">Lista de PAMI: Reumatoidea Renovación</h1>
      ...
      <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
          ...
          <div class="modal-body bg-dark text-white">
            <form name="pamiReumatoideaInicioForm" id="pamiReumatoideaInicioForm" method="post">
              ...
              <fieldset class="row mb-2">
                <label for="inputStartDate" class="col-sm-2 col-form-label">Fecha de inicio tto</label>
                <div class="col-sm-3">
              ...
              <div class="row mb-3">
                <label for="inputSummaryHC" class="col-sm-2 col-form-label text-uppercase">Actualización resumen de HC</label>
                <div class="col-sm-10">
    ...
    <script src="list-reumatoidea-renovacion.js"></script>
  </body>
</html>