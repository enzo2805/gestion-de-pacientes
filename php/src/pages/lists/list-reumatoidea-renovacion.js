...
$(document).ready( function () {
  var table = $('#table_id').DataTable({
    processing: true,
    serverSide: true,
    ajax: '/pages/lists/get-list-reumatoidea-renovacion.php',
    language: {
  ...
  $('#table_id tbody').on('click', 'button.ver', function () {
    ...
    fetch('http://localhost:8000/pages/lists/get-form-data-reumatoidea-renovacion.php', options)
      ...
      .then(data => {
        ...
        form.inputStartDate.value = data.fecha_ini_trat;
        form.inputWeight.value = data.peso;
        form.inputHeight.value = data.talla;
        form.inputSummaryHC.value = data.resumen_act_hc;
...
btnDeleteConfirmation.addEventListener('click', (event)=>{
  ...
  fetch('http://localhost:8000/pages/pami/delete-reumatoidea-renovacion.php', options)
