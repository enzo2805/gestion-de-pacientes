...
$query=mysqli_query($conn, $sql) or die("get-form-data-reumatoidea-renov.php: get form PAMI reumatoidea renov");
...
while( $row=mysqli_fetch_array($query) ) {  // preparing an array
    ...
    $nestedData['fecha_ini_trat']       = $row['fecha_ini_trat'];
    $nestedData['peso']                 = $row['peso'];
    $nestedData['talla']                = $row['talla'];
    $nestedData['resumen_act_hc']       = $row['resumen_act_hc'];
