  ...
  <body class="bg-light">
    ...
    <nav class="mt-2 mx-2" style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item badge bg-light active" aria-current="page">PAMI artritis reumatoidea renovación</li>
      </ol>
    </nav>
    <div class="container-fluid">
      <h1 class="display-6 text-uppercase">PAMI Artritis Reumatoidea renovación</h1>
    ...
    <script src="/js/bootstrap.bundle.min.js"></script>
      ...
      <script src="reumatoidea-renovacion.js"></script>
  </body>
</html>